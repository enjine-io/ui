function w3CodeColor(elmnt, mode) {
    ...
    var attributecolor = "mediumblue"; //"red";
    var attributevaluecolor = "mediumblue";
    var commentcolor = "green";
    var cssselectorcolor = "brown";
    var csspropertycolor = "mediumblue"; //"red";
    var csspropertyvaluecolor = "mediumblue";
    var cssdelimitercolor = "black";
    var cssimportantcolor = "blue"; //"red";

    var jscolor = "white";
    var jskeywordcolor = "#00bcd4";
    var jsstringcolor = "#d4e157"; //"brown";
    var jsnumbercolor = "#00bcd4"; //"red";
    var jspropertycolor = "white";

    //elmntObj.style.fontFamily = "Consolas,'Courier New', monospace";
    elmntObj.style.fontFamily = "Tahoma, sans-serif";
    if (!lang) { lang = "html"; }
